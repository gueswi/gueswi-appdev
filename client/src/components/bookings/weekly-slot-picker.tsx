          ...
          return (
            <button
              ...
              className={cn(
                ...
                (past || !staffWorksThisDay) && "opacity-30 cursor-not-allowed bg-gray-100 dark:bg-gray-800",
                !past && staffWorksThisDay && !selected && "border-gray-200 dark:border-gray-700 hover:border-blue-400 hover:bg-blue-50/30 dark:hover:bg-blue-900/20 bg-white dark:bg-gray-900",
                !past && staffWorksThisDay && selected && "border-blue-600 bg-blue-50 dark:bg-blue-900/40 shadow-md",
                today && !selected && staffWorksThisDay && "border-blue-300 bg-blue-50/20 dark:bg-blue-900/10"
              )}
            >
              ...
              <div
                className={cn(
                  "text-2xl font-bold",
                  selected && staffWorksThisDay && "text-blue-600 dark:text-blue-400",
                  today && !selected && staffWorksThisDay && "text-blue-500 dark:text-blue-300",
            ...
            {availableSlots.length === 0 ? (
              ...
              <div className="grid grid-cols-4 gap-2">
                {availableSlots.map((slot: any, index: number) => {
                  const slotTime = new Date(slot.startTime).toLocaleTimeString("es-ES", {
                    hour: "2-digit",
                    minute: "2-digit",
                  });
                  const isSelected =
                  ...
                  return (
                    <button
                      key={index}
                      onClick={() => handleSlotClick(selectedDay, {
                        time: slotTime,
                        available: true,
                        staffId: staffId,
                      })}
